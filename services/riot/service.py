...
def _resolve_provider() -> str:
    ...
    Reads the module-level HENRIK_API_KEY (captured from .env at import) so tests
    can control the provider by patching it. Adding a key to .env requires a
    server restart to take effect (uvicorn --reload does not reload env vars)."""
